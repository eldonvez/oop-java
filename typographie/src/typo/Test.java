...
public class Test {
	...
	static void test5() {
		...
		RelativeSpace rs = new RelativeSpace(1,f);
	...
	static void test6() {
		...
		TestableGroup tg = new TestableGroup();
		tg.add(new RelativeSpace(1,f));
		TestableGroup tg2 = new TestableGroup();
		tg2.add(new FixedSpace(5));
		tg2.add(new Space(2,3));
		tg.add(tg2);
